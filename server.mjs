...
// ✅ Environment Variable থেকে API Key নিন (কোডে সরাসরি API key নেই!)
const API_KEYS = [
  process.env.GEMINI_API_KEY,
  process.env.GEMINI_API_KEY_2,
  process.env.GEMINI_API_KEY_3,
].filter(Boolean);  // খালি values বাদ দেবে
...
- বন্ধুত্বপূর্ণ এবং সম্মানজনক টোনে কথা বলবেন
...
app.post("/ask", async (req, res) => {
  ...
  if (API_KEYS.length === 0) {
    return res.status(500).json({ 
      reply: "দুঃখিত, API key সেট করা নেই। Admin কে জানান। ⚠️",
